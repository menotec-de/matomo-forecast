...
class Controller extends \Piwik\Plugin\Controller
{
    ...
    public function getRawData(): string
    {
        ...
        $view->config->columns_to_display = ['nb_uniq_visitors', 'nb_visitors'];
        $view->config->translations['nb_uniq_visitors'] = 'Unique visitors';
        $view->config->translations['nb_visitors'] = 'Total visitors';
